...
contains
  ...
  subroutine write_observations(observations,obs_errors,obs_positions)
    ...
    ! Write the data
    call h5dwrite_f(dset_h,H5T_NATIVE_DOUBLE,observations,data_block,ierr,file_space_id=dataspace)
    ...
    ! Write the data
    call h5dwrite_f(dset_h,H5T_NATIVE_DOUBLE,obs_errors,data_block,ierr,file_space_id=dataspace)
    ...
    ! Write the data
    call h5dwrite_f(dset_h,H5T_NATIVE_INTEGER,obs_positions,data_block,ierr,file_space_id=dataspace)
